...
export class MapTools extends WebMapPlugin<{
  ...
  /** 工具池 */
  private _toolPool : Map<string, BaseTool<unknown>> = new Map()
   ...
   * @param tool 工具对象
   */
  public createCustomTool (key: string, tool: BaseTool<unknown>) : this {
   ...
   * @param key 工具Key
   */
  public getTool<T extends BaseTool<unknown>> (key: string) : T | null {
